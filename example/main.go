...
func main() {
	...
	conn := getRedis()
	defer conn.Close()
	//	log.Println(conn.Do("DEL", "ddddd"))
	log.Println(conn.Do("SET", "ddddd", 1))
	log.Println(conn.Do("EXPIRE", "ddddd", 10))
	log.Println(redis.Int(conn.Do("TTL", "ddddd")))
	time.Sleep(time.Second * 11)
	log.Println(redis.Int(conn.Do("GET", "ddddd")))
	//	log.Println(redis.Int(conn.Do("DEL", "ddddd")))
	//	log.Println(redis.Int(conn.Do("GET", "ddddd")))
	//	//	log.Println(conn.Do("SET", "ddddd", 12))
	//	//	log.Println(redis.Int(conn.Do("GET", "ddddd")))
	//	log.Println(conn.Do("MSET", "a", 1, "b", 2, "c", 3))
	//	log.Println(redis.Strings(conn.Do("MGET", "a", "b", "c")))
	//	log.Println(conn.Do("INCR", "ddddd"))
	//	log.Println(conn.Do("SET", "ddddd", "11"))
	//	log.Println(conn.Do("INCR", "ddddd"))
